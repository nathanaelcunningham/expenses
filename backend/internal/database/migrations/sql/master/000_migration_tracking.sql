...
VALUES (0, 'migration tracking', '000_migration_tracking.sql', 'Create schema_migrations table for tracking applied migrations', CURRENT_TIMESTAMP, 'master', 'bootstrap');