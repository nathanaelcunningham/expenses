...
func NewTransactionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TransactionServiceClient {
	...
	return &transactionServiceClient{
		getAccounts: connect.NewClient[v1.GetAccountsRequest, v1.GetAccountsResponse](
			httpClient,
			baseURL+TransactionServiceGetAccountsProcedure,
...
func (c *transactionServiceClient) GetAccounts(ctx context.Context, req *connect.Request[v1.GetAccountsRequest]) (*connect.Response[v1.GetAccountsResponse], error) {
...
func NewTransactionServiceHandler(svc TransactionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	transactionServiceMethods := v1.File_transaction_v1_transaction_proto.Services().ByName("TransactionService").Methods()
	transactionServiceGetAccountsHandler := connect.NewUnaryHandler(
		TransactionServiceGetAccountsProcedure,
		svc.GetAccounts,
		connect.WithSchema(transactionServiceMethods.ByName("GetAccounts")),
